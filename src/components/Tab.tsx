  ...
  return (
    <Link
      ...
      className={classnames(
        ...
        {
          "rounded-md font-bold md:rounded-none md:rounded-t-md md:border md:border-b-0 md:bg-transparent md:font-normal": active,
          "cursor-base bg-transparent hover:border-gray-400 dark:hover:border-gray-300 md:border-b": !active,
        },
      )}
    >
      {children}
