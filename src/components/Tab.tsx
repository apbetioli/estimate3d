  ...
  return (
    <Link
      ...
      className={classnames(
        "px-12 md:px-4 items-center whitespace-nowrap py-3 text-center text-sm text-gray-700 focus:outline-none dark:border-gray-500 dark:text-white sm:text-base md:border-gray-300",
        {
