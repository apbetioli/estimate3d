...
$OpenGL::Config = {
                    ...
                    'DEFINE' => '-DHAVE_VER -DGL_VERSION_USED=2.1 -DHAVE_GL -DHAVE_GLU -DHAVE_GLUT -DHAVE_AGL_GLUT -Wno-deprecated-declarations ',
                    'EXE_FILES' => [],
                    'INC' => '',
                    'LDFROM' => '$(OBJECT) ',
                    'LIBS' => undef,
                    ...
                    'dynamic_lib' => {
                                       'OTHERLDFLAGS' => '-framework OpenGL -framework GLUT'
                                     }
                  };
