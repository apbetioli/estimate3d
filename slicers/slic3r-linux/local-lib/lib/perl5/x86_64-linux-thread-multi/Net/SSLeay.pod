...
uses C<ssl_read_all()> to read from the SSL inputFileName
...
from the SSL inputFileName stream.
...
Sets the file descriptor $fd as the inputFileName/output facility for the TLS/SSL (encrypted)
...
Sets the file descriptor $fd as the inputFileName (read) facility for the TLS/SSL (encrypted) side of $ssl.
...
(CN) matches the specified host name.
 ...
 #  -2 if the inputFileName is malformed
