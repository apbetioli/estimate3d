...
wxIMAGELIST_DRAW_SELECTED
wxIMAGELIST_DRAW_FOCUSED) ];
$EXPORT_TAGS{'ipc'} = [ qw(wxIPC_ENHMETAFILE
wxIPC_UTF16TEXT
wxIPC_OEMTEXT
wxIPC_LOCALE
wxIPC_WAVE
...
wxEVT_COMMAND_RIBBONTOOL_CLICKED
wxEVT_COMMAND_RIBBONTOOL_DROPDOWN_CLICKED) ];
$EXPORT_TAGS{'ribbonart'} = [ qw(wxRIBBON_ART_GALLERY_BUTTON_DISABLED_BACKGROUND_GRADIENT_COLOUR
wxRIBBON_ART_PANEL_MINIMISED_LABEL_COLOUR
wxRIBBON_ART_TOOLBAR_FACE_COLOUR
wxRIBBON_ART_TAB_HOVER_BACKGROUND_COLOUR
wxRIBBON_ART_TOOL_BACKGROUND_TOP_COLOUR
...
wxTREE_HITTEST_ONITEMLOWERPART
wxTREE_HITTEST_ONITEM) ];
$EXPORT_TAGS{'webview'} = [ qw(wxWEB_NAV_ERR_AUTH
wxWEB_VIEW_BACKEND_IE
wxWEB_VIEW_RELOAD_NO_CACHE
wxWEB_NAV_ERR_CONNECTION
wxWEB_NAV_ERR_SECURITY
