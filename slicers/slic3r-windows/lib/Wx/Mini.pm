...
our $alien_key = 'msw_3_0_3_uni_cl_8';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'richtext' => 'wxmsw30u_richtext_vc_custom.dll',
          'media' => 'wxmsw30u_media_vc_custom.dll',
          'base' => 'wxbase30u_vc_custom.dll',
          'xml' => 'wxbase30u_xml_vc_custom.dll',
          'qa' => 'wxmsw30u_qa_vc_custom.dll',
          'xrc' => 'wxmsw30u_xrc_vc_custom.dll',
          'core' => 'wxmsw30u_core_vc_custom.dll',
          'ribbon' => 'wxmsw30u_ribbon_vc_custom.dll',
          'adv' => 'wxmsw30u_adv_vc_custom.dll',
          'aui' => 'wxmsw30u_aui_vc_custom.dll',
          'propgrid' => 'wxmsw30u_propgrid_vc_custom.dll',
          'webview' => 'wxmsw30u_webview_vc_custom.dll',
          'net' => 'wxbase30u_net_vc_custom.dll',
          'stc' => 'wxmsw30u_stc_vc_custom.dll',
          'gl' => 'wxmsw30u_gl_vc_custom.dll',
          'html' => 'wxmsw30u_html_vc_custom.dll'
        };
;
}
...
sub _alien_path {
  ...
  return unless length 'msw_3_0_3_uni_cl_8';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/msw_3_0_3_uni_cl_8" ) {
      $wx_path = "$_/Alien/wxWidgets/msw_3_0_3_uni_cl_8/lib";
      last;
    }
  }
}
